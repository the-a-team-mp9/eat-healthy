    ...
    renderproptext(){
        ...
        if(this.props.section_id=='1')
            ...
            <Container style={{backgroundColor:'rgba(40,40,40,0.75)',marginTop:"20px",marginBottom:'15px'}}>
                <Row className='justify-content-md-center' style={{marginTop:'15px'}}>
                    <Col md={'auto'} xs={12} sm={12} lg={'auto'}>
                        <p style={{textDecorationStyle:'none',fontSize:'1.2em',color:'white'}}>Tips to gain weight healthily</p>
                    </Col>
                </Row>
                <Row className='justify-cotent-md-center'>
                <Col  md={'auto'} xs={12} sm={12} lg={'auto'}>                    
                <p style={{textAlign:'justify',color:'white',marginBottom:'0px'}}>1. Avoid pressuring your child to eat. 
                ...
                <p style={{textAlign:'justify',color:'white',marginBottom:'0px'}}>2. Don’t rush meal times. Slow eaters need more time to eat.</p>
                <p style={{textAlign:'justify',color:'white',marginBottom:'0px'}}>3. Wait until the end of your child’s meal or 
                ...
                <p style={{textAlign:'justify',color:'white',marginBottom:'0px'}}>4. Choose high calorie foods such as meats, 
                ...
                <p style={{textAlign:'justify',color:'white',marginBottom:'0px'}}>5. Encourage physical activity. 
        ...
        if(this.props.section_id=='2'){
            return(
                <Container style={{backgroundColor:'rgba(40,40,40,0.75)',marginTop:"20px",marginBottom:'15px'}}>
                    <Row className='justify-content-md-center' style={{marginTop:'15px'}}>
                        <Col md={'auto'} xs={12} sm={12} lg={'auto'}>
                            <p style={{textDecorationStyle:'none',fontSize:'1.2em',color:'white'}}>Tips to maintain a healthy weight</p>
                        </Col>
                    </Row>
                    <Row className='justify-cotent-md-center'>
                    <Col  md={'auto'} xs={12} sm={12} lg={'auto'}>                    
                    <p style={{textAlign:'justify',color:'white',marginBottom:'0px'}}>1. Continue eating healthy foods and encourage children to 
                    be physically active</p>
                    <p style={{textAlign:'justify',color:'white',marginBottom:'0px'}}>2. Limit intake of foods high in saturated fat such as many biscuits, cakes, pastries, 
                        pies, processed meats, commercial burgers, pizza, fried foods, potato chips, 
                        crisps and other savoury snacks. 
                    </p>
                    <p style={{textAlign:'justify',color:'white',marginBottom:'0px'}}>3. Limit intake of foods and drinks containing added sugars such as confectionary, 
                        sugar-sweetened soft drinks and cordials, fruit drinks, vitamin waters energy and
                        sports drinks.
                    </p>
                    <p style={{textAlign:'justify',color:'white',marginBottom:'0px'}}>4. Replace high fat foods which contain predominately saturated fats such as butter, 
                    ...
                    <p style={{textAlign:'justify',color:'white',marginBottom:'0px'}}>5. Read labels to choose lower sodium options among similar foods.</p>
                    </Col>
                    </Row>
                </Container> 
            );
        ...
        if(this.props.section_id=='3'){
            return(
                <Container style={{backgroundColor:'rgba(40,40,40,0.75)',marginTop:"20px",marginBottom:'15px'}}>
                    <Row className='justify-content-md-center' style={{marginTop:'15px'}}>
                        <Col md={'auto'} xs={12} sm={12} lg={'auto'}>
                            <p style={{textDecorationStyle:'none',fontSize:'1.2em',color:'white'}}>Tips to loose weight</p>
                        </Col>
                    </Row>
                    <Row className='justify-cotent-md-center'>
                    <Col  md={'auto'} xs={12} sm={12} lg={'auto'}>                    
                    <p style={{textAlign:'justify',color:'white',marginBottom:'0px'}}>1. Reduce sedentary time. In addition to encouraging physical activity, help children avoid too much sedentary 
                    ...
                    <p style={{textAlign:'justify',color:'white',marginBottom:'0px'}}>2. Control what foods children eat. Some foods are not essential in children's diets. These are called 'discretionary 
